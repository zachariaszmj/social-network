package com.soft4u.socialnetwork.auth.domain.util;
...
public class JwtUtil {
    ...
    @Value("${social-network.auth.secret}")
    ...
    private BearerToken createToken(Map<String, Object> claims, String subject) {
        ...
        return new BearerToken(accessToken, date);
    }
